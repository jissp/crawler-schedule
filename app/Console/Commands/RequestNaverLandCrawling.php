...
use App\Client\CrawlerClient\NaverLandClient\Enums\HouseHoldTag;
...
class RequestNaverLandCrawling extends Command
{
    ...
    public function handle(): void
    {
        ...
        array_map(function (CrawlingRequestDto $dto) use ($client) {
            $dto->tag = [];
            ...
            /** 한강 위 - 아파트, 오피스텔 */
            $this->buildRequestDto(z: 14, lat: 37.5501803, lon: 127.0066441, btm: 37.5245898, lft: 126.8894423, top: 37.5757621, rgt: 127.1238459, tags: [HouseHoldTag::HSEH100]),
            /** 한강 아래 - 아파트, 오피스텔 */
            $this->buildRequestDto(z: 14, lat: 37.5133571, lon: 126.9804658, btm: 37.4732802, lft: 126.8486298, top: 37.5534126, rgt: 127.1123017, tags: [HouseHoldTag::HSEH100]),
            /** 수서, 위례, 판교, 수지 */
            $this->buildRequestDto(z: 13, lat: 37.4261615, lon: 127.1095551, btm: 37.3180478, lft: 127.0111931, top: 37.5341192, rgt: 127.2079171, tags: [HouseHoldTag::HSEH100]),
//            /** 강남 */
